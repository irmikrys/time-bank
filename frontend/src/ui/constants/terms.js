...
const LINKS_PARAGRAPGH =
  ...
  "\n" +
  "Our Company (change this) has no control over, and assumes no responsibility for, " +
  "the content, privacy policies, or practices of any third party web sites or services. " +
  "You further acknowledge and agree that My Company (change this) shall not be " +
